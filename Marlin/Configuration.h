...
#define STRING_CONFIG_H_AUTHOR "(XTLW3D and community)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "XTLW 6"
 ...
 */
#define NOZZLE_TO_PROBE_OFFSET { 8, 48, 0 }
...
//#define Z_SAFE_HOMING
  ...
  #define Z_SAFE_HOMING_X_POINT 160    // X point for Z homing when homing all axes (G28).
  #define Z_SAFE_HOMING_Y_POINT 155    // Y point for Z homing when homing all axes (G28).
#endif
...
#define NOZZLE_PARK_FEATURE
  ...
  #define NOZZLE_PARK_POINT { 158.5, 15, 20 }
